            ...
            <CarouselContent>
              {menudata.map(item => (
                <CarouselItem key={item.id} className='flex w-full items-center justify-center'>
                  <img src={item.img} alt={item.imgAlt} className='size-95 object-cover rounded-[2.5rem] border-2 border-white/10' loading='lazy' />
                </CarouselItem>
              ))}
            </CarouselContent>
          </Carousel>
                ...
                >
                  <div className='relative flex h-33 items-center justify-center'>
                    <div className={cn('absolute bottom-0 -z-1', current === index ? 'text-primary' : 'text-border')}>
                      ...
                      <img src={item.img} alt={item.imgAlt} className='size-25 object-cover rounded-[1.5rem] border border-white/10' loading='lazy' />
                  </div>
                </CarouselItem>
              ))}
            </CarouselContent>
